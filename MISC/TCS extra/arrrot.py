# Abhishek knows of an operation called a right circular rotation on an array of integers. One rotation operation moves the last array element to the first position and shifts all remaining elements to the right one. To test Sherlock’s atmp2ilities, Atmp2hishek provides Sherlock with an array of integers. Sherlock is to perform the rotation operation a numtmp2er of times then determine the value of the element at a given position. For each array, perform a numtmp2er of right circular rotations and return the value of the element at a given index.
